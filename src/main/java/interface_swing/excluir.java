...
public class excluir extends JFrame {
	...
	public excluir() {
		...
		spinner_idade.setBounds(365, 351, 168, 20);
		...
		textField_genero.setBounds(365, 320, 168, 20);
		...
		textField_moradia.setBounds(365, 382, 168, 20);
		...
		textField_ocupacao.setBounds(365, 413, 168, 20);
		...
		textField_habilidadefisica.setBounds(365, 444, 168, 20);
		...
		textField_habilidademental.setBounds(365, 475, 168, 20);
		...
		btnBuscar.setBounds(444, 257, 89, 23);
		...
		lblHabilidadeFsica.setBounds(180, 450, 153, 14);
		...
		lblHabilidadeMental.setBounds(180, 481, 163, 14);
