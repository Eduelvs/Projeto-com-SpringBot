...
public class tela {
	...
	private void initialize() {
		frmTela = new JFrame();
		frmTela.setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Users\\eduar\\Downloads\\fundoHora.jpg"));
		...
		JMenuItem mntmNovo = new JMenuItem("Inserir");
		...
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\eduar\\Downloads\\novoFundo.jpg"));
